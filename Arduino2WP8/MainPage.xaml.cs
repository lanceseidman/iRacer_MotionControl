...
namespace Arduino2WP8
{
   // [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable")]
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        int isEnabled = 0; // Use to store when we can turn on Sensor, or w/e else
        ...
        */
        ...
        void accelSensor_CurrentValueChanged(object sender, SensorReadingEventArgs<AccelerometerReading> e)
        {
          ...
          //  txtY.Text = e.SensorReading.Acceleration.Y.ToString("0.00");
          //  txtZ.Text = e.SensorReading.Acceleration.Z.ToString("0.00");
         //   if (isEnabled == 1)
          //  {
        ...
        private void GoChange(AccelerometerReading accelerometerReading)
        {
            ...
            if (BTSock != null)
            {
                System.Threading.Thread.Sleep(1000); // USE TIMERS! 2 RC CARS BLEW UP BECAUSE OF SPEED.
        ...
        private async void MainPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // GET & SHOW ONLY SPECIFIC PAIRED DEVICE
              for (int i = 0; i < 4; i++) // Show 4 Paired or use peers.Count
              {
                 // if (peers[i].DisplayName.Contains("DaguCar")) // Uncomment for Specific Device
                 // {
                      lstBTPaired.Items.Add(peers[i].DisplayName); // Add the DaguCar since it was found.
                      txtBTStatus.Text = "Found RC Car";
                      
              }
                   // We can't find it. Is it Turned on? Named something else?
                 // else
                 // {
...
*/
            ...
            ACC_Sensor.TimeBetweenUpdates = TimeSpan.FromSeconds(5); // May wish to change based on Feedback
        ...
        private async void lstBTPaired_Tap_1(object sender, GestureEventArgs e)
        {
            if (lstBTPaired.SelectedItem == null) // To prevent errors, make sure something is Selected
            {
                ...
                await BTSock.ConnectAsync(peers[lstBTPaired.SelectedIndex].HostName, "1"); // Connect using Socket to Selected Item
                isEnabled = 1;
